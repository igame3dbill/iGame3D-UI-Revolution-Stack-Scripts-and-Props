...
explanation=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
acc=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
decc=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
rollleft=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
rollright=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
strafeleft=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
straferight=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
start=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
mspeed=make(ig3d_text_box, "Data/FontPngs/monaco32_1.png")
...
cfile=io.open(getSceneInfo(IG3D_ROOT).."Data/controls.txt","w")
for i=1,6,1 do
